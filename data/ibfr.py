...
result_dir = './Result_FCandSignal_BasedPatch_Anchor/NYU_PatchSize_Variations'
image_dir = './NYU'
mask_dir = './template'
...
anchor_arr_3 = sitk.GetArrayFromImage(
    sitk.ReadImage('./AnchorMask/NewFixedCoordinateWithGMmask_forAnchorSize32/AnchorPatch_mask_112AnchorNum_617361.nii')
)
