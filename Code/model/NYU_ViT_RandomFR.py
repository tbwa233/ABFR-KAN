"""
Note: This is the baseline RandomFR model
"""
import torch
...
class ViT(nn.Module):
    def __init__(self, *, num_classes, dim, depth, heads, mlp_dim, pool = 'cls', channels = 3, dim_head = 32, dropout = 0., emb_dropout = 0.):
        ...
        self.transformer = Transformer(dim + dim, depth, heads, dim_head, mlp_dim, dropout)
    ...
    def forward(self, x, posi):
        ...
        x = torch.cat((x, pos_project), dim=-1)
        x = self.dropout(x)
