...
GMmask = sitk.GetArrayFromImage(sitk.ReadImage('/path/to/Data_Preparation/template/GreyMatterMask_181217181.nii.gz')) # Update with the path to your own GreyMatterMask_181217181.nii.gz file
...
origin_image = sitk.ReadImage('/path/to/Data_Preparation/template/ch2bet.nii') # Update with the path to your own ch2bet.nii.gz file
...
reference_volume = sitk.ReadImage(f'/path/to/Data_Preparation/template/BrainMask_05_617361.nii') # Update with the path to your own BrainMask_05_617361.nii file
