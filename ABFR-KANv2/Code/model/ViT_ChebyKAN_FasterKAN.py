...
# ----------------------------
# FasterKAN Classification Head
# ----------------------------
class FasterKANHead(nn.Module):
    def __init__(self, input_dim, hidden_dim, num_classes):
        super().__init__()
        # identical structure to your KANHead
        self.kan = FasterKAN([input_dim, hidden_dim, num_classes])
...
# ----------------------------
# Hybrid ViT
# ChebyKAN Encoder + FasterKAN Head
# ----------------------------
class ViT(nn.Module):
    def __init__(
        self,
