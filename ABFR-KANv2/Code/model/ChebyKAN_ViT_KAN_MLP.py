...
# ----------------------------
# ChebyKAN FeedForward (FFN) for Encoder Only
# ----------------------------
...
# ----------------------------
# Standard MLP Classification Head (NOT ChebyKAN)
# ----------------------------
...
# ----------------------------
# ViT with ChebyKAN Only in Encoder FFNs
# ----------------------------
class ViT(nn.Module):
    def __init__(
        self,
        *,
        ...
        # Classification head is a NORMAL MLP
    ...
    def forward(self, x, posi):
        ...
        # Add positional projection
        pos_project = self.pos_project(posi)
        x += pos_project
        x = self.dropout(x)

        # Transformer encoder with ChebyKAN FFNs
